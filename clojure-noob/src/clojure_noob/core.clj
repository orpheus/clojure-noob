...
;; cannot nest anonymous function using the '#' syntax due to operator confusion
;; can't know if '%1' is referring to inner or outer fn
((fn [& powers]
   (map (fn [power] (str "Avatar Power: " power)) powers))
 "Fire" "Water" "Earth" "Air")

;; Exercise: Pulling It All Together: Hobbit Smacking
...
(defn matching-part
  "Construct a matching part for the asym hobbit"
  [part]
